package it.reloia.tecnoutils.client.keybindings;
...
public class SettingsKeyBinding {
    public static final String TOGGLE_HUD = "key.tecnoutils.open_settings";
    public static final String TOGGLE_HUD_CATEGORY = "key.categories.tecnoutils";
